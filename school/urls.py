...
urlpatterns = [
    path('parents/', ParentsAPIView.as_view(), name='parents_api'),
    ...
    path('parents-phones/', PhonesAPIView.as_view(), name='phones_api'),
    ...
    path('subjects/', SubjectsAPIView.as_view(), name='subjects_api'),
    ...
    path('teachers/', TeachersAPIView.as_view(), name='teachers_api'),
